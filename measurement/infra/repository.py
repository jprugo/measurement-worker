...
class MeasurementRepository(RDBRepository):
    ...
    def find_latest_records_for_all_measure_types(session: Session):
        ...
        # Obtener los tipos de medida distintos
        ...
        for measure_type in measure_types:
            ...
            # Obtener los detalles distintos para el tipo de medida
            ...
            for detail in details:
                ...
                # Consultar el último registro para el tipo de medida y detalle
